...
const insertIntoDB = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = new Date(
      payload === null || payload === void 0 ? void 0 : payload.publicationDate,
    )
...
const getAllBooks = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { size, page, skip } =
      paginationHelpers_1.paginationsHelpers.calculatePagination(options)
...
const getBookBuCategoryId = (id, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { size, page } =
      paginationHelpers_1.paginationsHelpers.calculatePagination(options)
...
const updateSingleBookById = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
